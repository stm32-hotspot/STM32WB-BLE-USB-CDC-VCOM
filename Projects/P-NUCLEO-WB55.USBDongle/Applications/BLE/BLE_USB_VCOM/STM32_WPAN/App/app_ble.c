...
uint8_t ad_data[13] = {
    ...
    9, AD_TYPE_COMPLETE_LOCAL_NAME, 'B', 'L', 'E', '-', 'V', 'C', 'O', 'M',  /* Complete name */
...
/* USER CODE BEGIN PFP */
void usb_cdc_send_data( void ); //[JT]
/* USER CODE END PFP */
...
/* USER CODE BEGIN APP_BLE_Init_3 */
  UTIL_SEQ_RegTask( 1<< CFG_TASK_USB_CDC_SEND_DATA_ID, UTIL_SEQ_RFU, usb_cdc_send_data );   //[JT]
  UTIL_SEQ_RegTask( 1<< CFG_TASK_BLE_SEND_DATA_ID, UTIL_SEQ_RFU, ble_send_data );           //[JT]
